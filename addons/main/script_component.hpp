...
// own stupid shit
#define QUATRUPLE(var1,var2,var3,var4) ##var1##_##var2##_##var3##_##var4

// ACE macros
#define ACEGVAR(var1,var2) TRIPLES(ace,var1,var2)
#define QACEGVAR(var1,var2) QUOTE(ACEGVAR(var1,var2))
#define ACEFUNC(var1,var2) QUATRUPLE(ace,var1,fnc,var2)
#define QACEFUNC(var1,var2) QUOTE(ACEFUNC(var1,var2))
#define EFUNC(var1,var2) ACEFUNC(var1,var2)
